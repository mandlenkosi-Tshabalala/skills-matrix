...
namespace SkillsMatrix.Web.Pages.Auth
{
    public class RegisterBase : ComponentBase
    {
        ...
        protected async void HandleValidSubmit()
        {
            ...
            if (result.Succeeded)
            {
                toastService.ShowError("User created.");
                ...
                //    MailAddress address = new MailAddress("zibhovazi@gmail.com");
                //    msg.From = address;
                ...
                //    NetworkCredential credentials = new NetworkCredential("zibhovazi@gmail.com", "Kasaraji10!");
                ...
                //    //string mailFrom = "noreply@snakepark.com";
